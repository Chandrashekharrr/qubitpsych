  ...
  return (
    <nav className=" w-full h-[10vh]   flex  justify-between items-center px-5">
      <div className="logo z-50">
        <h1 className={`${hennyPenny.className} text-[#070f36] text-[6vw] md:text-[3vw] `}>
          ToyNinjaa
        </h1>
      </div>
      ...
      {isOpen ? (
        <div className="navbaroverlay bg-[linear-gradient(180deg,rgba(141,201,244,1)_41%,rgba(255,255,255,1)_81%,rgba(255,255,255,1)_100%)] fixed w-full h-full top-0 left-0 z-30  transition-all duration-[2000ms] ease-in-out "></div>
      ) : (
